...
export class News extends Component {
    ...
    async componentDidMount(){
      let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=c8456e2d173845cab3aaae5dc47d6ab4&pageSize=${this.props.pageSize}`;
    ...
    handlePrevClick = async ()=>{
        console.log("CLicked");
        let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=c8456e2d173845cab3aaae5dc47d6ab4&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({loading:true});
